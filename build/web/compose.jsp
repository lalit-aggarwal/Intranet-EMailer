...
<form action="ComposePageController">
   ...
   <table border="0" cellpadding="0" CELLSPACING="0" ALIGN="left"><br>
       <tr>
     <td><P ><font size="3" color=#800000><b>sending to:</b></FONT></td>
<TD><FONT SIZE="3" COLOR=#800000><input type="radio" name="sendto" value="others" />Others 
<input type="radio" name="sendto" value="wowmail" />Wowmail</FONT></TD></TR>
...
<tr>
     ...
     <td><textarea rows="40" cols="150" name="content">type Your text here</textarea></td>
   </tr>
