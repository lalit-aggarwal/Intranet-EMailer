...
<P><FONT SIZE="5" COLOR=#800000><U>CHANGE PROFILE PICTURE</U></FONT></P></div>
    

<div id="FORM" style="width:700px;float:left;">

<form  enctype="multipart/form-data" action="ProfilePicController" >
...
<tr><td></td><td><input class='button' type="submit" value="UPLOAD"  name="mpage">
